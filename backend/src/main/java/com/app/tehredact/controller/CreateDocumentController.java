...
public class CreateDocumentController {
    ...
    @Autowired
    private ComplaintDocumentService complaintService;

    @Autowired
    private PowerOfAttorneyDocumentService powerOfAttorneyService;

    @Autowired
    private StatementOfClaimDocumentService statementOfClaimService;
